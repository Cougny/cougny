...
| Production deployment (droplet)     | [deployment.md](./deployment.md)                           |
...
> AI-assistant rules live in [`CLAUDE.md`](../CLAUDE.md) / [`AGENTS.md`](../AGENTS.md)
> / [`.github/copilot-instructions.md`](../.github/copilot-instructions.md) —
> those three files are mirrors and must stay identical.
